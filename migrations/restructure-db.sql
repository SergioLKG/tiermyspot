-- Last migrations 29/09/2025
-- Crear tabla temporal para guardar datos de playlists
CREATE TABLE temp_playlists AS SELECT * FROM playlists;

-- Crear tabla temporal para guardar datos de rankings
CREATE TABLE temp_rankings AS SELECT * FROM rankings;

-- Crear tabla temporal para guardar relaciones usuario-playlist
CREATE TABLE temp_user_playlists AS SELECT * FROM user_playlists;
...
DROP TABLE temp_user_playlists;