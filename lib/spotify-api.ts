...
export async function getPlaylistTracks(
  ...
  let tracks: any[] = [];
  let url = `https://api.spotify.com/v1/playlists/${playlistId}/tracks?market=${market}&limit=50&fields=items(track(id,name,album(images(url)),artists(id,name,href))),next`;
